...
tenant_id = '05e03292-6ca6-4f26-8c66-4b1e0ce68037'
client_secret = "2B08Q~Qa7mE-IrqkS6HyuC9mPpYm01s60u6YnaoD"
application_id = '18edded3-3130-4d99-9ce0-f88dfaa04ebf'

endpoint = 'https://ecf-prod-openai-apim-001.azure-api.net/clone/openai/deployments/apim-test-deployment/completions?api-version=2022-12-01'
...
if 'error' in acquire_tokens_result:
    ...
    rt = requests.post(url=endpoint, headers=header_token, data=request_data)
